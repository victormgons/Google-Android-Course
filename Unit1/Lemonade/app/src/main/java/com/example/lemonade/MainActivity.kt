...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        if(lemonadeState == RESTART){
            ...
            lemonText.setText("Click to select a lemon!")
            lemonadeState = SELECT
        }else if(lemonadeState == SELECT){
            lemonImage.setImageResource(R.drawable.lemon_squeeze)
            lemonText.setText("Click to juice the lemon!")
            lemonTree = LemonTree()
            ...
            if(lemonSize > 0){
                ...
                lemonText.setText("Click to drink your lemonade!")
                lemonadeState = DRINK
                lemonSize = -1
            }
        }else if(lemonadeState == DRINK){
            lemonImage.setImageResource(R.drawable.lemon_restart)
            lemonText.setText("Click to start again!")
